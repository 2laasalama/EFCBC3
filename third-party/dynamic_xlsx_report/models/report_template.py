...
class ReportTemplate(models.Model):
    ...
    mapping_ids = fields.One2many('template.mapping.line', 'template_id', string='Mapping')
    report_id = fields.Many2one('ir.actions.report', string='Report', readonly=True)
    type = fields.Selection([('xlsx', 'XLSX'), ('qweb-pdf', 'PDF'), ], required=True, default="xls")
...
class TemplateMappingLine(models.Model):
    ...
    template_id = fields.Many2one('report.template', ondelete='cascade')
